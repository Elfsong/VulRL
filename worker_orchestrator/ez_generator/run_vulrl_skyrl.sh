...
echo "  Total GPUs: $NUM_GPUS (0=CPU, 1+=GPU)"
echo "  Policy/Ref Training GPUs: $POLICY_NUM_GPUS"
echo "  Inference Engines: $INFERENCE_NUM_ENGINES (TP=1 -> $INFERENCE_NUM_ENGINES GPUs)"
echo "  Colocate All: $COLOCATE_ALL"
...
echo "  Policy/Ref Training GPUs: $POLICY_NUM_GPUS"
echo "  Inference Engines: $INFERENCE_NUM_ENGINES (local VLLM, TP=1 -> $INFERENCE_NUM_ENGINES GPUs)"
echo "  Colocate All: $COLOCATE_ALL"
echo "  GPU Memory Utilization: ${GPU_MEMORY_UTILIZATION}"
echo ""
